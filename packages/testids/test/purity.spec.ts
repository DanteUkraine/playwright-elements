...
test.describe('testids package purity', () => {
  test('lib/builder loads exactly 2 modules (builder + strippable)', () => {
  ...
  test('exports all expected functions', () => {
    ...
    const expected = ['assertNoPrefixCollisions', 'bareFactory', 'factory', 'isIdFactory', 'ns', 'sid', 'testIdProps', 'testIdValue', 'unsafeId'].join(',');
